...
def _hash_password(password: str) -> str:
    """Genera hash SHA256 con salt. Compatible con cualquier Python 3.6+"""
    import os
...
def _verify_password(stored: str, password: str) -> bool:
    """Verifica hash. Soporta formato sha256$salt$hash y PLAIN: para dev"""
    ...
    if stored.startswith('sha256$'):
        try:
            ...
            return False
    # Intentar werkzeug como fallback si está disponible
    try:
...
def generate_password_hash(password: str, **kwargs) -> str:
